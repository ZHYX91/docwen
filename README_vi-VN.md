...
| Hàng loạt | Markdown |
| --- | --- |
| ![Bảng hàng loạt](assets/screenshots/batch.png) | ![Bảng Markdown](assets/screenshots/markdown.png) |

| Tài liệu | Bảng tính |
| --- | --- |
| ![Bảng tài liệu](assets/screenshots/document.png) | ![Bảng bảng tính](assets/screenshots/spreadsheet.png) |

| Ảnh | Tệp bố cục |
| --- | --- |
| ![Bảng ảnh](assets/screenshots/image.png) | ![Bảng bố cục](assets/screenshots/layout.png) |

Nhật ký thay đổi: xem [doc/CHANGELOG.md](doc/CHANGELOG.md)
