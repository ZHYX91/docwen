...
def main(argv: list[str]) -> int:
    ...
    _contains_all(
        ...
        [
            ...
            f'uv run python -m pytest -o addopts="{pytest_addopts}" -n "$env:{xdist_workers_env}" --dist {xdist_dist} --cov --cov-config=pyproject.toml --cov-report=term-missing:skip-covered',
