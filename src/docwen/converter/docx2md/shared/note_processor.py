...
def extract_footnotes_from_docx(doc, docx_path: str | None = None) -> dict[int, str]:
    """
    从Word文档中提取所有脚注
...
def extract_endnotes_from_docx(doc, docx_path: str | None = None) -> dict[int, str]:
    """
    从Word文档中提取所有尾注
...
def build_footnote_definitions(footnotes: dict[int, str], id_map: dict[int, int] | None = None) -> str:
    """
    生成Markdown格式的脚注定义块
...
def build_endnote_definitions(endnotes: dict[int, str], id_map: dict[int, int] | None = None) -> str:
    """
    生成Markdown格式的尾注定义块
...
class NoteExtractor:
    ...
    def __init__(self, doc, docx_path: str | None = None):
        """
        初始化提取器
    ...
    def get_footnote_md_id(self, word_id: int) -> int | None:
        """
    ...
    def get_endnote_md_id(self, word_id: int) -> int | None:
        """
