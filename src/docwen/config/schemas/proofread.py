...
class ProofreadConfigMixin:
    ...
    def get_typos(self) -> dict[str, list]:
        ...
        return {k: v for k, v in typos.items() if isinstance(v, list)}
    ...
    def get_sensitive_words(self) -> dict[str, list]:
        ...
        return {k: v for k, v in words.items() if isinstance(v, list)}
    ...
    def get_symbol_map(self) -> dict[str, list]:
        ...
        return {str(k): v for k, v in symbol_map.items() if isinstance(v, list)}
