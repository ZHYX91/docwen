...
class OptimizationConfigMixin:
    ...
    def get_optimization_type_names(self, locale: str = None) -> List[str]:
        """
    ...
    def get_localized_optimization_types(self, locale: str = None) -> Dict[str, str]:
        """
    ...
    def get_optimization_type_by_name(self, type_name: str) -> Dict[str, Any]:
        ...
        """
        types = self.get_optimization_types()
        for type_id, type_config in types.items():
    ...
    def has_optimization_types(self, locale: str = None) -> bool:
        """
        检查当前语言是否有可用的优化类型
        ...
        返回:
            bool: 是否有可用的优化类型
        """
        type_names = self.get_optimization_type_names(locale)
