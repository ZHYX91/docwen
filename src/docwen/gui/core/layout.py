...
class MainWindowLayoutBuilder(ScalableMixin):
    ...
    def _create_top_section(self, parent: tb.Frame) -> Tuple[tb.Labelframe, Any]:
        ...
        try:
            ...
            file_drop_area = tb.Label(
                top_frame, text=t("components.file_drop.unavailable"),
    ...
    def _create_template_section(self, parent: tb.Frame) -> Tuple[tb.Frame, Any, Any]:
        ...
        try:
            ...
            tabbed_template_selector = tb.Label(template_frame, text=t("components.template_selector.unavailable"), bootstyle="danger")
        ...
        try:
            ...
            conversion_panel = tb.Label(right_panel_container, text=t("components.conversion_panel.unavailable"), bootstyle="danger")
    ...
    def _create_batch_section(self, parent: tb.Frame) -> Tuple[tb.Frame, Any]:
        ...
        try:
            ...
            tabbed_batch_file_list = tb.Label(batch_frame, text=t("components.file_selector.unavailable"), bootstyle="danger")
