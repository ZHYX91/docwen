...
class BaseSettingsTab(tb.Frame, ABC):
    ...
    def _create_scrollable_container(self) -> None:
        ...
        self.scrollable_frame = tb.Frame(
            self.canvas,
            padding=(0, 0, scale(self.layout_config.scrollbar_spacing), 0)
        )
    ...
    def create_section_frame(
        ...
        frame = tb.Labelframe(
            parent,
            text=title,
            padding=scale(self.layout_config.section_padding),
    ...
    def create_software_card(
        ...
        try:
            ...
            # 后备颜色
            fallback_colors = {
                "wps_writer": "#DC3545", "wps_spreadsheets": "#DC3545",
                "msoffice_word": "#0D6EFD", "msoffice_excel": "#0D6EFD",
                "libreoffice": "#198754"
            }
