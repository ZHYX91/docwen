...
class BaseEditorDialog(tb.Toplevel, ScalableMixin, ABC):
    ...
    def _on_close(self):
        ...
        if self.has_unsaved_changes:
            if not self._show_confirm(t("editors.common.confirm_close"), t("editors.common.unsaved_close_message")):
                return
