...
class LoggingTab(BaseSettingsTab):
    ...
    def _create_logging_system_section(self):
        ...
        frame = self.create_section_frame(
            ...
            t("settings.logging.system_section"),
        ...
        # 创建双向映射
        self._log_level_display_to_value = dict(zip(log_level_display, self._log_level_values))
        self._log_level_value_to_display = dict(zip(self._log_level_values, log_level_display))
    ...
    def _create_file_output_section(self):
        ...
        frame = self.create_section_frame(
            self.scrollable_frame,
            t("settings.logging.file_section"),
            SectionStyle.INFO
        )
    ...
    def _create_console_output_section(self):
        ...
        frame = self.create_section_frame(
            self.scrollable_frame,
            t("settings.logging.console_section"),
