...
class DocumentTab(BaseSettingsTab):
    ...
    def _create_extraction_section(self):
        ...
        frame = self.create_section_frame(
            ...
            t("settings.document.extraction_section"),
            SectionStyle.DANGER
        )
    ...
    def _create_optimization_section(self):
        ...
        optimization_types_dict = self.config_manager.get_localized_optimization_types()
        ...
        frame = self.create_section_frame(
            self.scrollable_frame,
            t("settings.document.optimization_section"),
            SectionStyle.INFO
        )
        ...
        type_label = tb.Label(
            right_frame,
            text=t("settings.document.optimization_type_label"),
    ...
    def _create_software_priority_section(self):
        ...
        frame = self.create_section_frame(
            self.scrollable_frame,
            t("settings.document.software_section"),
        ...
        doc_label = tb.Label(
            frame,
            text=t("settings.document.word_processors_label"),
        ...
        odt_label = tb.Label(
            frame,
            text=t("settings.document.odt_conversion_label"),
            font=(self.small_font, self.small_size, "bold")
        )
        ...
        pdf_label = tb.Label(
            frame,
            text=t("settings.document.document_to_pdf_label"),
            font=(self.small_font, self.small_size, "bold")
        )
    ...
    def _create_docx_to_md_numbering_section(self):
        ...
        frame = self.create_section_frame(
            self.scrollable_frame,
            t("settings.document.numbering.section"),
        ...
        if default_scheme in scheme_id_to_name:
            ...
            logger.debug(f"配置的序号方案不适用于当前语言，使用: {list(self._docx_numbering_schemes.keys())[0]}")
        else:
            default_scheme_name = ""
        ...
        scheme_label = tb.Label(
            right_frame,
            text=t("settings.document.numbering.scheme_label"),
            font=(self.small_font, self.small_size)
        )
