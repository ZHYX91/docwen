...
class ConfigCombobox(tb.Combobox):
    ...
    def __init__(
        ...
        translate_key_prefix: Optional[str] = None,
        translate_keys: Optional[dict] = None,
        ...
        **kwargs
        ...
        logger.debug("ConfigCombobox 初始化完成: config_values=%s, initial=%s", 
                    config_values, self._config_var.get())
