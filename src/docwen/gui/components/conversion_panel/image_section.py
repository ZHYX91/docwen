...
class ImageSectionMixin:
    ...
    def _create_compress_options(self):
        ...
        compress_options_frame = tb.Labelframe(
            self.conversion_container,
            text=t("conversion_panel.image.compression_options"),
            bootstyle="info"
        )
        ...
        quality_info = create_info_icon(
            lossless_frame,
            t("conversion_panel.image.highest_quality_tooltip"),
            bootstyle="info"
        )
        ...
        limit_info = create_info_icon(
            limit_frame,
            t("conversion_panel.image.limit_file_size_tooltip"),
            bootstyle="info"
        )
    ...
    def _create_saveas_pdf_section(self):
        ...
        size_options_frame = tb.Labelframe(
            self.saveas_container,
            text=t("conversion_panel.image.size_options"),
            bootstyle="info"
        )
        ...
        self.quality_original_radio = tb.Radiobutton(
            quality_radio_frame, text=t("conversion_panel.image.original_embed"), variable=self.pdf_quality_var,
        ...
        self.quality_a4_radio = tb.Radiobutton(
            quality_radio_frame, text=t("conversion_panel.image.fit_a4"), variable=self.pdf_quality_var,
        ...
        self.quality_a3_radio = tb.Radiobutton(
            quality_radio_frame, text=t("conversion_panel.image.fit_a3"), variable=self.pdf_quality_var,
    ...
    def _create_image_merge_section(self):
        ...
        tiff_options_frame = tb.Labelframe(
            self.extra_container,
            text=t("conversion_panel.image.conversion_options"),
            bootstyle="info"
        )
        ...
        tiff_smart_info = create_info_icon(
            option1_frame,
            t("conversion_panel.image.preserve_transparency_tooltip"),
            bootstyle="info"
        )
        ...
        tiff_rgb_info = create_info_icon(
            option2_frame,
            t("conversion_panel.image.no_transparency_tooltip"),
            bootstyle="info"
        )
