...
class LayoutSectionMixin:
    ...
    def _create_layout_saveas_section(self):
        ...
        dpi_options_frame = tb.Labelframe(
            self.saveas_container,
            text=t("conversion_panel.layout.image_quality_dpi"),
            bootstyle="info"
        )
        ...
        self.dpi_150_radio = tb.Radiobutton(
            dpi_radio_frame, text=t("conversion_panel.layout.minimum_150"), variable=self.layout_image_dpi_var,
        ...
        self.dpi_300_radio = tb.Radiobutton(
            dpi_radio_frame, text=t("conversion_panel.layout.moderate_300"), variable=self.layout_image_dpi_var,
        ...
        self.dpi_600_radio = tb.Radiobutton(
            dpi_radio_frame, text=t("conversion_panel.layout.high_definition_600"), variable=self.layout_image_dpi_var,
    ...
    def _create_layout_merge_split_section(self):
        ...
        ToolTip(
            ...
            t("conversion_panel.layout.merge_to_pdf_tooltip")
        )
        ...
        ToolTip(
            ...
            t("conversion_panel.layout.split_to_pdf_tooltip")
        )
        ...
        page_range_info = create_info_icon(
            input_frame,
            t("conversion_panel.layout.page_range_info"),
            bootstyle="info"
        )
            ...
            if max_page > self.pdf_total_pages:
                ...
                if valid_pages:
                    ...
                    if set(valid_pages) == set(range(1, self.pdf_total_pages + 1)):
                        ...
                        return False
                    # 显示警告
                    self._show_page_warning(t("conversion_panel.layout.pages_out_of_range_adjusted", pages=self.pdf_total_pages))
                    return True
                else:
                    self._show_page_warning(t("conversion_panel.layout.all_pages_out_of_range", pages=self.pdf_total_pages))
                    return False
            else:
                # 6. 检查是否涵盖全部页码
