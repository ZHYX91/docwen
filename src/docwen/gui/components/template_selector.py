...
class TemplateSelector:
    ...
    def __init__(self, master, template_type: str, on_template_selected: Callable | None = None, **kwargs):
    ...
    def _create_template_list_area(self):
        ...
        self.canvas = tb.Canvas(self.master, highlightthickness=0)
        self._refresh_canvas_theme()
        ...
        self.scrollbar = tb.Scrollbar(self.master, orient=tk.VERTICAL, command=bounded_yview, bootstyle="round-info")
        ...
        self.master.bind("<<ThemeChanged>>", lambda _e: self._refresh_canvas_theme(), add="+")

        self._show_empty_state()

    def _refresh_canvas_theme(self):
        try:
    ...
    def _create_template_item(self, template_name: str):
        ...
        bind_single_line_ellipsis(name_label, template_name)
