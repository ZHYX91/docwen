...
class FileToMdMixin:
    ...
    def _create_document_conversion_buttons(self):
        ...
        ToolTip(
            ...
            t("action_panel.document.export_markdown_tooltip")
        )
        
        # 导出选项边框
        doc_export_options_frame = tb.Labelframe(
            self.button_container,
            text=t("action_panel.export_options"),
            bootstyle="info"
        )
        ...
        if default_scheme_id in scheme_id_to_name:
            ...
            default_scheme_id = list(self._doc_numbering_schemes.keys())[0]
        ...
        self._doc_optimization_types = self.config_manager.get_localized_optimization_types()
        ...
        extract_image_info = create_info_icon(
            extract_image_container,
            t("action_panel.extract_images_tooltip"),
            bootstyle="info"
        )
        ...
        if self._has_optimization_types:
            ...
            optimization_check_info = create_info_icon(
                optimization_container,
                t("action_panel.document.optimize_for_type_tooltip"),
                bootstyle="info"
            )
        ...
        remove_numbering_info = create_info_icon(
            remove_numbering_container,
            t("action_panel.document.remove_existing_numbering_tooltip"),
            bootstyle="info"
        )
        ...
        add_numbering_info = create_info_icon(
            add_numbering_container,
            t("action_panel.document.add_new_numbering_tooltip"),
            bootstyle="info"
        )
    ...
    def _on_convert_document_to_md_clicked(self):
        ...
        if self.on_action:
            ...
            optimization_type = self.doc_optimization_type_var.get() if hasattr(self, 'doc_optimization_type_var') else ""
            ...
            if enable_optimization:
                ...
                optimize_for_type = name_to_id.get(
                    optimization_type,
                    getattr(self, "_default_doc_optimization_type_id", "gongwen")
                )
            else:
            ...
            if hasattr(self, 'doc_remove_numbering_var') and self.doc_remove_numbering_var is not None:
                ...
                if hasattr(self, 'doc_numbering_scheme_var') and self.doc_numbering_scheme_var is not None:
                    ...
                    options['doc_numbering_scheme'] = name_to_id.get(
                        scheme_name,
                        getattr(self, "_default_doc_numbering_scheme_id", "gongwen_standard")
                    )
    ...
    def _create_spreadsheet_to_md_button(self):
        ...
        ToolTip(
            ...
            t("action_panel.spreadsheet.export_markdown_tooltip")
        )
    ...
    def _create_image_conversion_buttons(self):
        ...
        ToolTip(
            ...
            t("action_panel.image.export_markdown_tooltip")
        )
        ...
        extract_image_info = create_info_icon(
            extract_image_container,
            t("action_panel.image.extract_images_tooltip"),
            bootstyle="info"
        )
        extract_image_info.pack(side=tk.LEFT)
        ...
        extract_ocr_info = create_info_icon(
            extract_ocr_container,
            t("action_panel.image.ocr_tooltip"),
            bootstyle="info"
        )
        extract_ocr_info.pack(side=tk.LEFT)
    ...
    def _create_layout_conversion_buttons(self):
        ...
        ToolTip(
            ...
            t("action_panel.layout.export_markdown_tooltip")
        )
        
        # 提取选项边框
        extraction_frame = tb.Labelframe(
            self.button_container,
            text=t("action_panel.extraction_options"),
            bootstyle="info"
        )
