...
class ActionPanelBase(tb.Frame):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # 标题序号选项变量（文档转MD）
        self.doc_remove_numbering_var: tk.BooleanVar | None = None
        self.doc_add_numbering_var: tk.BooleanVar | None = None
        self.doc_numbering_scheme_var: tk.StringVar | None = None
        self.doc_numbering_scheme_combo: tb.Combobox | None = None

        # 标题序号选项变量（MD转文档）
        self.md_remove_numbering_var: tk.BooleanVar | None = None
        self.md_add_numbering_var: tk.BooleanVar | None = None
        self.md_numbering_scheme_var: tk.StringVar | None = None
        self.md_numbering_scheme_combo: tb.Combobox | None = None

        # 存储按钮引用
        self.convert_docx_button: tb.Button | None = None
        self.convert_doc_button: tb.Button | None = None
        self.convert_odt_button: tb.Button | None = None
        self.convert_rtf_button: tb.Button | None = None
        self.convert_excel_button: tb.Button | None = None
        self.convert_xls_button: tb.Button | None = None
        self.convert_ods_button: tb.Button | None = None
        self.convert_csv_button: tb.Button | None = None
        self.convert_document_to_md_button: tb.Button | None = None
        self.convert_spreadsheet_to_md_button: tb.Button | None = None
        self.convert_image_to_md_button: tb.Button | None = None
        self.convert_layout_to_md_button: tb.Button | None = None
        ...
        # 创建支持DPI的按钮样式配置
        self.button_style_3 = {"width": 12, "padding": (scale(10), scale(5))}
        self.button_style_2 = {"width": 16, "padding": (scale(10), scale(5))}
        self.button_style_1 = {"width": 20, "padding": (scale(10), scale(5))}
    ...
    def _create_widgets(self):
        ...
        bind_label_wraplength_to_container(
            self.status_label, self.main_frame, min_wraplength=scale(240), padding=scale(20)
        )
    ...
    def set_status(self, message: str, is_error: bool = False):
        ...
        if is_error:
            self.status_var.set(t("messages.error_prefix", message=message))
        else:
    ...
    def get_selected_options(self) -> dict[str, Any]:
        ...
        try:
            localized_schemes = self.config_manager.get_localized_numbering_schemes()
        except Exception:
            localized_schemes = {}

        scheme_name_to_id = {name: scheme_id for scheme_id, name in localized_schemes.items()}

        try:
            default_scheme_id = self.config_manager.get_default_numbering_scheme()
        except Exception:
