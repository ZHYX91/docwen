...
from docwen.utils.file_type_utils import is_supported_file, get_file_category, get_allowed_types_by_category
...
class FileDropArea(tb.Frame):
    ...
    def _create_widgets(self):
        ...
        # 创建标题标签（根据当前模式动态显示提示）
        hint_key = "components.file_drop.empty_hint_single" if self.mode == "single" else "components.file_drop.empty_hint_batch"
    ...
    def _on_mode_changed(self):
        ...
        # 更新提示文本
        hint_key = "components.file_drop.empty_hint_single" if new_mode == "single" else "components.file_drop.empty_hint_batch"
    ...
    def _open_file_dialog(self):
        ...
        if self.mode == "single":
            ...
            file_path = filedialog.askopenfilename(
                ...
                filetypes=[
                    (t("messages.all_supported_files"), "*.md;*.txt;*.docx;*.doc;*.wps;*.rtf;*.odt;*.xlsx;*.xls;*.et;*.csv;*.ods;*.pdf;*.xps;*.ofd;*.tif;*.tiff;*.jpg;*.jpeg;*.png;*.bmp;*.gif;*.heic;*.heif;*.webp"),
