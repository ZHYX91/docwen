...
from docwen.utils.file_type_utils import get_file_category, get_category_name, get_actual_file_category
...
class SelectorManager:
    ...
    def _show_no_files_state(self):
        ...
        if self._is_initializing:
            ...
            # 批量模式：显示选项卡无文件提示
            category_name = get_category_name(self.current_category) if self.current_category else t('file_types.unknown')
