...
使用示例：
    from docwen.gui.components.common import ButtonFactory
...
class ButtonFactory:
    ...
    STYLES: ClassVar[dict[str, dict[str, Any]]] = {
        "3col": {"width": 8, "padding_x": 8, "padding_y": 4},
        "2col": {"width": 10, "padding_x": 8, "padding_y": 4},
        "1col": {"width": 16, "padding_x": 8, "padding_y": 4},
        "action": {"width": 20, "padding_x": 10, "padding_y": 5},
        "action_medium": {"width": 16, "padding_x": 10, "padding_y": 5},
        "action_small": {"width": 12, "padding_x": 10, "padding_y": 5},
    }
    ...
    def create_format_button(
        ...
        button = tb.Button(
            parent, text=button_text, command=command, bootstyle=button_style, state=state, **style_config
        )
    ...
    def create_action_button(
        ...
        button = tb.Button(parent, text=text, command=command, bootstyle=bootstyle, state=state, **style_config)
    ...
    def create_disabled_button(
        cls, parent: tb.Frame, text: str, style_size: str = "2col", tooltip_text: str | None = None
    ) -> tb.Button:
        """
        创建禁用状态的按钮
        ...
        button = tb.Button(
            parent, text=text, command=lambda: None, bootstyle="secondary", state="disabled", **style_config
        )
