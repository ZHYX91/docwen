...
使用示例:
    from docwen.gui.components.file_selector import FileSelector, FileInfo, TabbedFileSelector
...
def __getattr__(name: str):
    if name == "TabbedFileSelector":
        from .tabbed import TabbedFileSelector as _TabbedFileSelector

        return _TabbedFileSelector
