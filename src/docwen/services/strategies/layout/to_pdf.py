        ...
        try:
            ...
            if actual_format == 'pdf':
                ...
                return ConversionResult(
                    ...
                    message=t('conversion.messages.file_already_pdf')
                )
            ...
            return ConversionResult(
                success=False,
                message=t('conversion.messages.format_to_pdf_not_implemented', format=format_name)
            )
...
class OfdToPdfStrategy(BaseStrategy):
    ...
    def execute(
        ...
        try:
            ...
            return ConversionResult(success=False, message=t('conversion.messages.format_to_pdf_not_implemented', format='OFD'))
        except Exception as e:
