...
class DocumentToOfdStrategy(BaseStrategy):
    ...
    def execute(
        ...
        """
        msg = t("conversion.messages.ofd_conversion_not_implemented")
        return ConversionResult(success=False, message=msg, error_code=ERROR_CODE_NOT_IMPLEMENTED, details=msg)
