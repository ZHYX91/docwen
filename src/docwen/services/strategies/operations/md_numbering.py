    ...
    def execute(
        ...
        if not remove_numbering and not add_numbering:
            return ConversionResult(
                success=False,
                message=t('conversion.messages.no_numbering_operation')
            )
        ...
        try:
            ...
            if progress_callback:
                progress_callback(t('conversion.progress.reading_file'))
            ...
            # 处理序号
            if progress_callback:
                progress_callback(t('conversion.progress.processing_numbering'))
            ...
            # 写回文件
            if progress_callback:
                progress_callback(t('conversion.progress.saving_file'))
