...
def load_image_icon(icon_name: str, master: any, size: Optional[tuple[int, int]] = None) -> Optional[PhotoImage]:
    """
...
def _load_image_with_pil(icon_path: str, master: any, size: Optional[tuple[int, int]], cache_key: str) -> Optional[PhotoImage]:
    """
    使用PIL库加载和缩放图像（高质量）
    """
...
def _load_image_native(icon_path: str, master: any, size: Optional[tuple[int, int]], cache_key: str) -> Optional[PhotoImage]:
    """
