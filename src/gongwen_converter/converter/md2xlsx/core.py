    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            if warnings:
                ...
                if progress_callback:
                    progress_callback(f"转换完成，但有 {len(warnings)} 处数据因只读单元格无法填充")
...
def _convert_internal(
    ...
    try:
        ...
        # 3. 提取所有表格数据
        if progress_callback:
            progress_callback("正在提取Markdown表格...")
