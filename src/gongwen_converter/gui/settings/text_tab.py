...
class TextTab(BaseSettingsTab):
    ...
    def _create_md_to_docx_numbering_section(self):
        ...
        self.create_checkbox_with_info(
            frame,
            '默认清除原有 Markdown 小标题序号',
            self.md_to_docx_remove_var,
            'MD转DOCX时默认清除Markdown中已有的标题序号',
    ...
    def _create_numbering_section(self):
        ...
        desc_label = tb.Label(
            frame,
            text="管理 MarkDown 与文档互转时，小标题序号的清理和新增方案。",
            bootstyle="secondary",
    ...
    def _on_edit_numbering_schemes(self):
        ...
        try:
            from gongwen_converter.gui.settings.heading_numbering_editor import (
    ...
    def _on_edit_numbering_patterns(self):
        ...
        try:
            from gongwen_converter.gui.settings.numbering_patterns_editor import (
