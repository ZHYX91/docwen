...
from gongwen_converter.converter.table_merger import TableMerger
    ...
    def execute(
        ...
        try:
            ...
            if success:
                ...
                return ConversionResult(success=False, message=message)
        
        except Exception as e:
            error_msg = f"表格汇总策略执行异常: {str(e)}"
            logger.error(error_msg, exc_info=True)
            return ConversionResult(success=False, message=error_msg, error=e)
