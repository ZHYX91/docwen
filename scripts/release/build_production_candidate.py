...
MACHINE_CONTRACT_PATHS = (
    "contracts/schemas/docwen.machine.v2.schema.json",
    "contracts/schemas/docwen.machine.diagnostic_evidence.v1.schema.json",
    "contracts/schemas/docwen.artifact_bundle.v3.schema.json",
    ...
    "contracts/fixtures/invalid/machine.legacy-bundle-producer.trace.json",
    "contracts/fixtures/valid/machine.templates.response.json",
    "contracts/fixtures/invalid/machine.templates.missing-origin.json",
    "contracts/fixtures/invalid/machine.templates.missing-is-default.json",
    "contracts/fixtures/invalid/machine.templates.invalid-origin.json",
    "contracts/fixtures/invalid/machine.templates.invalid-is-default.json",
    "contracts/fixtures/invalid/machine.templates.invalid-id.json",
    "contracts/fixtures/invalid/machine.templates.invalid-target.json",
    "contracts/fixtures/invalid/machine.templates.invalid-path.json",
    "contracts/fixtures/invalid/machine.initialize.legacy-major.json",
    "contracts/fixtures/invalid/machine.initialize.future-minor.json",
