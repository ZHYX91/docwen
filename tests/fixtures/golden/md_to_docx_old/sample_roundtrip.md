...
This text has another endnote[^endnote-2].

# Heading with Text Test

## Title Ending with Punctuation: When a heading ends with punctuation and is immediately followed by body text (no blank line), they form a combined heading-paragraph block.
...
[^endnote-2]: This is a named endnote.
