...
- `files/ocr_tables/mixed-tables.png`: synthetic ruled/borderless multi-table and prose corpus for `verify_packaged_cli.py --table-smoke`; see its adjacent provenance and oracle.
