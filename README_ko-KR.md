...
- 완전한 국제화 지원 (GUI 및 CLI에서 11개 언어 지원).
- 향상된 호환성을 위해 PaddleOCR을 RapidOCR로 대체.
- 다국어 Word/Excel 템플릿 추가.
- 템플릿 스타일 자동 감지 및 주입.
- 기타 최적화 및 수정.

### v0.5.1 (2025-01-01)

- 양방향 수학 공식 변환 추가 (Word OMML ↔ Markdown LaTeX).
- 양방향 각주/미주 변환 추가.
- 코드, 인용 등의 문자 및 단락 스타일 추가.
- 목록 처리 향상 (다단계 중첩, 자동 번호 매기기).
- 표 기능 향상 (스타일 감지/주입, 3선 표 등).
- 부제목 번호 정리 및 추가 최적화.
- 인터페이스 상호 작용 및 설정 연동 개선.

### v0.4.1 (2025-12-05)

- 사용자 경험 향상을 위한 CLI 리팩토링.
- 더 많은 문서 유형 지원 추가.
- 더 많은 구성 가능한 옵션 구현.
